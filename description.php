...
<head>
    ...
    <title>Alba Store - Descripción del producto</title>
    <!-- Favicon-->
            ...
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex">
                        ...
                        <button class="btn btn-outline-dark flex-shrink-0" type="button" onclick="addProducto(<?php echo $id; ?>,'<?php echo $token_tmp; ?>')">
                            <i class="bi-cart-fill me-1"></i>
                            Añadir al carrito
                        </button>
